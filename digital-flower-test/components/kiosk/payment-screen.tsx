  ...
  return (
    ...
    >
      <div className="flex flex-col h-full items-center px-6 pt-3 pb-4 gap-4">
        {/* Total card */}
        <div style={{ width: '100%', padding: '0.75rem', background: 'rgba(103,143,116,0.1)', border: '1.5px solid rgba(103,143,116,0.3)', textAlign: 'center' }}>
          <p style={{ fontFamily: 'var(--font-display)', fontSize: '0.65rem', color: '#724E2A', marginBottom: '0.2rem' }}>{t.payment.total}</p>
          <p style={{ fontFamily: 'var(--font-serif)', fontSize: '2rem', color: '#FDAA5C', fontWeight: 600 }}>
        ...
        {showMethodSelection && (
          <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <h2 style={{ fontFamily: 'var(--font-serif)', fontSize: '1rem', color: '#274324', textAlign: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.6rem' }}>
              ...
              >
                ...
                <span style={{ fontFamily: 'var(--font-serif)', fontSize: '0.85rem', color: '#274324' }}>{t.payment.card}</span>
              </button>
              ...
              >
                ...
                <span style={{ fontFamily: 'var(--font-serif)', fontSize: '0.85rem', color: '#274324' }}>{t.payment.cash}</span>
              </button>
            </div>
        ...
        {showCardInstructions && (
          <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '0.75rem', alignItems: 'center' }}>
            <div style={{ padding: '1.25rem', background: 'rgba(103,143,116,0.1)', border: '1.5px solid rgba(103,143,116,0.3)', textAlign: 'center', width: '100%' }}>
            ...
            <button
              ...
              style={{ ...btnBase, padding: '0.75rem', background: '#274324', color: '#F7D08D', width: '100%', cursor: isProcessing ? 'wait' : 'pointer' }}
            >
              {isProcessing ? (
        ...
        {showCashForm && (
          <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <div style={{ padding: '0.75rem', background: 'rgba(237,226,194,0.5)', border: '1px solid rgba(114,78,42,0.2)', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <div>
                ...
                <Input
                  ...
                  style={{ fontFamily: 'var(--font-sans)', background: 'rgba(237,226,194,0.8)', border: '1px solid rgba(114,78,42,0.3)' }}
                />
              </div>
              <div>
                <label style={{ fontFamily: 'var(--font-display)', fontSize: '0.65rem', fontWeight: 700, color: '#274324', display: 'block', marginBottom: '0.3rem' }}>
